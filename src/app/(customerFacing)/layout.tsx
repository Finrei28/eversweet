...
export default function CustomerFacingLayout({
  ...
  return (
    <>
      ...
      >
        {language === "en"
          ? "We will be closed today on the 28/07/2026. Sorry for the inconvenience! We will be back to normal business hours tomorrow. Thank you for your understanding!"
          : "我们将于2026年7月28日（今天）休息一天。对于由此带来的不便，我们深表歉意！我们将于明天恢复正常营业时间。感谢您的理解！"}
      </NotificationModal>
    </>
  );
}
