...
export default function CustomerFacingLayout({
  ...
  return (
    <>
      ...
      >
        {language === "en"
          ? "We are be closed today on the 28/07/2026. Sorry for the inconvenience! We will be back to normal business hours tomorrow. Thank you for your understanding!"
